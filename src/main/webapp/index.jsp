...
if ("POST".equalsIgnoreCase(request.getMethod())) {
    ...
    try {
        conn = data.DBConnection.getConnection();
        ...
        if (rs.next()) {
            if (password.equals(rs.getString("password"))) {
                ...
                out.println("Usuario y/o contraseña incorrecta");
            }
        } else {
        ...
        <div class="login-box">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header text-center">
                    <a href="index.php" class="h1"><b>HRMS</b>PYT</a>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    ...
                    <form action="index.jsp" method="post">
                        <div class="input-group mb-3">
                            <input type="email" class="form-control" placeholder="Email" id="email" name="email" autocomplete="on">
